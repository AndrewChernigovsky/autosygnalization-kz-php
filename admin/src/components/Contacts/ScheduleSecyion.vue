  ...
  try {
    ...
    if (success && data) {
      contacts.value = data.filter(
        (item: ContactItem) => item.type === 'schedule'
      );
    } else {
...
<template>
  <div class="container">
    <h2 class="contacts-title">График работы</h2>

    <div class="add-contact-wrapper">
      <h2 class="add-contact-title">Добавить новый График работы</h2>
      <form @submit.prevent="createContact" class="add-contact-form">
        <div class="input-group">
          <label for="schedule-create">График работы:</label>
          <textarea
            id="schedule-create"
    ...
    <div>
      <div class="contact-list">
        ...
        >
          <div class="input-group">
            <label :for="'content-' + item.contact_id">График работы:</label>
            <textarea
