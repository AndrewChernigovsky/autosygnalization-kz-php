  ...
  <div class="container">
    ...
    <div class="add-contact-wrapper">
      ...
      <form @submit.prevent="createContact" class="add-contact-form">
        <div class="input-group">
          <label for="address-create">Адрес:</label>
          <input type="text" id="address-create" v-model="newContact.content" />
        </div>
    ...
    <div>
      <div class="contact-list">
        ...
        >
          <div class="input-group">
            <label :for="'content-' + item.contact_id">Адрес:</label>
            <input
              type="text"
