      ...
      'ОПИСАНИЕ' => [
        'items' => [
          [
            ...
            'path-icon' => "/assets/images/products/advantages/dialogue-protection-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/radio-protection-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/super-slave-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/temperature-range-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/energy-eco-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/control-channel-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/pin-authorization-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/3d-control-white.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/invisible-blocking-white.avif",
          ],
        ],
        'items-service' => [
          [
            ...
            'path-icon' => "/assets/images/products/advantages/telematics.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/gsm-control.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/gps-glonass.avif",
          ],
          [
            'title' => 'АВТОЗАПУСК',
            ...
            'path-icon' => "/assets/images/products/advantages/autostart.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/2can2lin.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/flex-channel.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/shockproff-keychain.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/ikey.avif",
          ],
        ],
      ],
      'ХАРАКТЕРИСТИКИ' => [
      ...
      'ОПИСАНИЕ' => [
        'items' => [
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/smart-authorization.avif",
          ],
          [
            'title' => 'УМНЫЙ ДИАЛОГ',
        ...
        'items-service' => [
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/logika.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/2can-4lin.avif",
          ],
          [
      ...
      'ОПИСАНИЕ' => [
        ...
        'items-service' => [
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/control-channel-white.svg",
          ],
        ],
      ],
      'ХАРАКТЕРИСТИКИ' => [
      ...
      'ОПИСАНИЕ' => [
        'items' => [
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/relay-protection.avif",
          ],
          [
            'title' => 'УМНЫЙ ДИАЛОГ',
            'description' => 'Умный диалоговый код управления c индивидуальными ключами шифрования гарантирует надежную защиту от всех известных кодграбберов',
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/sound.avif",
          ],
          [
            'title' => 'SUPER SLAVE',
        ...
        'items-service' => [
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/3can4lin.avif",
          ],
          [
            'title' => 'УПРАВЛЕНИЕ С ТЕЛЕФОНА',
          ...
          [
            ...
            'path-icon' => "/assets/images/products/advantages/2sim.avif",
          ],
          [
            ...
            'path-icon' => "/assets/images/products/advantages/functions-smart-diagnostic.avif",
          ],
        ],
      ],
      'ХАРАКТЕРИСТИКИ' => [
