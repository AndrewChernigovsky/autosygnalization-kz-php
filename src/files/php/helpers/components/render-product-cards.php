       ...
       ?>
          <article class='product-card' id="<?php echo htmlspecialchars($item['id']); ?>">
            <div class="product-card__bg">
              <img src="<?php echo htmlspecialchars($item['gallery'][$random_bg]); ?>" alt="<?php echo htmlspecialchars($item['description']); ?>" width="300" height="250">
            </div>
            <div class="product-card__body">
              <div class="product-card__head">
                ...
                <?php if (isset($item['price'])): ?>
                  <p>
                    <span>Цена:</span> <?php echo htmlspecialchars($item['price']); ?>
              ...
              <?php if (!$this->cart): ?>
                  <div class="product-card__buttons">
                    ...
                    <button type="button" class="button y-button-primary cart-button" data-id="<?php echo htmlspecialchars($item['id']); ?>" data-cost="<?= $item['price'] ?>">Купить</button>
                  </div>
              <?php endif; ?>
