...
$sertificates = [
  "$path/assets/images/sertificates/sertificate-1.avif",
  "$path/assets/images/sertificates/sertificate-2.avif",
  "$path/assets/images/sertificates/sertificate-3.avif",
  "$path/assets/images/sertificates/sertificate-4.avif",
  "$path/assets/images/sertificates/sertificate-5.avif",
];
?>
