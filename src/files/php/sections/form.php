<section class="form" id="form">
  <div class="form__wrapper">
    ...
    <form class="form__main-form" action="#" method="post" id="form">
      <fieldset class="form__fieldset">
        <legent class="form__subtitle">Марка:</legent>
        <div class="form__group-radio">
          <input class="form__radio form__radio--genesis" type="radio" name="mark" id="genesis">
      ...
      <ul class="form__list list-style-none">
        ...
        <li class="form__item">
          <label class="form__subtitle">Год выпуска:
            <input class="form__input" type="number" name="release-year" id="release-year" placeholder="2024" required>
          </label>
        </li>
        <li class="form__item">
          <label class="form__subtitle">Имя:
            <input class="form__input" type="text" name="name" id="name" placeholder="Ivanov Ivan Ivanovich" required>
          </label>
        </li>
        <li class="form__item">
          <label class="form__subtitle">Телефон:
            <input class="form__input" type="tel" name="user-tel" id="user-tel" placeholder="+7 (777) 77 77 777" required>
          </label>
        </li>
