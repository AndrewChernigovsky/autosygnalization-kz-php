...
try {
    ...
    if (isset($tabs[$tabIndex]['description'][$itemIndex]['path-icon'])) {
        $iconPath = $tabs[$tabIndex]['description'][$itemIndex]['path-icon'];
        if ($iconPath) {
            $fileFullPath = __DIR__ . '/../../../../../' . parse_url($iconPath, PHP_URL_PATH);
    ...
    $tabs[$tabIndex]['description'][$itemIndex]['path-icon'] = '';
