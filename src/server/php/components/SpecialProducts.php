    ...
    <section class="offers">
      <div class="swiper swiper-offers">
        ...
        <ul class="offers__list list-style-none swiper-wrapper">
          <?php if (!empty($products)): ?>
            <?php foreach ($products as $product): ?>
              <?php if (!empty($product['is_special']) && !empty($product['gallery'])): ?>
                <li class="offers__item swiper-slide">
                  <img class="offers__image" src="<?php echo htmlspecialchars($product['gallery'][0] ?? ''); ?>"
                    alt="<?php echo htmlspecialchars($product['title'] ?? ''); ?>" height="300" width="200">
                  ...
                  <a class="y-button-secondary button offers__link-more"
        ...
        <div class="offers__container">
          <a class="offers__link-all" href="<?= "/autosygnals-special?SELECT=name&type=special&special=true" ?>">Все
            предложения</a>
