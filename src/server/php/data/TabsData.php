    ...
    public function getData()
    {
        $data = [
              ...
              'ОПИСАНИЕ' => [
                'items' => [
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/dialogue-protection-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/radio-protection-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/super-slave-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/temperature-range-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/energy-eco-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/control-channel-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/pin-authorization-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/3d-control-white.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/invisible-blocking-white.avif",
                  ],
                ],
                'items-service' => [
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/telematics.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/gsm-control.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/gps-glonass.avif",
                  ],
                  [
                    'title' => 'АВТОЗАПУСК',
                    ...
                    'path-icon' => "/client/images/products/advantages/autostart.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/2can2lin.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/flex-channel.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/shockproff-keychain.avif",
                  ],
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/ikey.avif",
                  ],
                ],
              ],
              'ХАРАКТЕРИСТИКИ' => [
              ...
              'ОПИСАНИЕ' => [
                'items' => [
                  ...
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/smart-authorization.avif",
                  ],
                  [
                    'title' => 'УМНЫЙ ДИАЛОГ',
                ...
                'items-service' => [
                  ...
                  [
                    ...
                    'path-icon' => "/client/images/products/advantages/logika.avif",
                  ],
                  [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                'items' => [
                  ...
                  [
                    'title' => 'ЗАЩИТА ОТ РАДИОПОМЕХ',
                    'description' => 'StarLine уверенно работает в условиях экстремальных городских радиопомех',
                    'path-icon' => "/client/images/products/advantages/radio-protection-white.avif",
                  ],
                  [
                    'title' => 'УМНЫЙ 3D КОНТРОЛЬ',
                ...
                'items-service' => [
                  ...
                  [
                    ...
                    'description' => 'Программируемые параметры управления аварийной световой сигнализацией, складыванием зеркал при постановке на охрану и многое другое',
                    'path-icon' => "/client/images/products/advantages/logika.avif",
                  ],
                  [
                    'title' => 'УМНАЯ ЦИФРОВАЯ ИНТЕГРАЦИЯ',
                  ...
                  [
                    'title' => 'ТЕЛЕМАТИКА',
                    'description' => 'Управляйте охраной автомобиля из любой точки мира. Передовые технологии GSM-GPRS, GPS-ГЛОНАСС на страже вашего спокойствия',
                    'path-icon' => "/client/images/products/advantages/telematics.avif",
                  ],
                  [
                    'title' => 'УМНЫЙ БЕСКЛЮЧЕВОЙ ОБХОД',
                  ...
                  [
                    ...
                    'description' => 'Управляйте охранными и сервисными функциями, получайте оповещения о статусе охраны на ваш мобильный телефон',
                    'path-icon' => "/client/images/products/advantages/gsm-control.avif",
                  ],
                  [
                    'title' => 'ВСЕГДА НА СВЯЗИ',
                    'description' => 'Режим автоматического переключения SIM-карт обеспечивает постоянный контроль транспортного средства, даже в случае потери сигнала одного из сотовых операторов.',
                    'path-icon' => "/client/images/products/advantages/control-channel-white.svg",
                  ],
                ],
              ],
              'ХАРАКТЕРИСТИКИ' => [
                [
                  'title' => 'Функции',
                  'description' => 'Автозапуск, Управление с телефона, Бесплатный мониторинг, Умная авторизация по Bluetooth Smart , Управление предпусковым подогревом , Блокировка двигателя по CAN, Умная автодиагностика, Данные о пробеге и уровне топлива',
                ],
                [
                  'title' => 'Категория',
                  'description' => 'Для легкового авто, Для внедорожника',
              ...
              'ГАРАНТИЯ' => [
                [
                  'description' => 'Гарантия 5 лет при условии установки в нашем авторизованном центре.',
                ],
              ],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
            ],
          ...
          [
            ...
            'tabs' => [
              ...
              'ХАРАКТЕРИСТИКИ' => [
                [
                  'title' => 'Функции',
                  'description' => 'Автозапуск, Управление предпусковым подогревом , Блокировка двигателя по CAN',
                ],
                [
                  'title' => 'Категория',
                  'description' => 'Для легкового авто, Для внедорожника',
          ...
          [
            ...
            'tabs' => [
              ...
              'ХАРАКТЕРИСТИКИ' => [
                ...
                [
                  'title' => 'Категория',
                  'description' => 'Для легкового авто',
                ],
              ],
              'ГАРАНТИЯ' => [],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
          ...
          [
            ...
            'tabs' => [
              ...
              'ХАРАКТЕРИСТИКИ' => [
                [
                  'title' => 'Функции',
                  'description' => 'Автозапуск, Управление с телефона, Управление предпусковым подогревом',
                ],
                [
                  'title' => 'Категория',
                  'description' => 'Для легкового авто, Для внедорожника',
          ...
          [
            ...
            'tabs' => [
              ...
              'ХАРАКТЕРИСТИКИ' => [
                [
                  'title' => 'Функции',
                  'description' => 'Автозапуск, Управление с телефона, Бесплатный мониторинг, Управление предпусковым подогревом , Блокировка двигателя по CAN',
                ],
                [
                  'title' => 'Категория',
                  'description' => 'Для легкового авто, Для внедорожника',
              ...
              'ГАРАНТИЯ' => [
                [
                  'description' => 'Гарантия 5 лет при условии установки в нашем сервисе.',
                ],
              ],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
            ],
          ...
          [
            ...
            'tabs' => [
              ...
              'ХАРАКТЕРИСТИКИ' => [
                [
                  'title' => 'Функции',
                  'description' => 'Блокировка двигателя по CAN',
                ],
              ],
              'ГАРАНТИЯ' => [
                [
                  'description' => 'Гарантия 5 лет при условии установки нашим специалистом и регистрации на сайте my.starline.ru',
                ],
              ],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
            ],
              ...
              'ОПИСАНИЕ' => [
                'items' => [
                  ...
                  [
                    ...
                    'description' => 'Надежная защита от перехвата сигнала штатного брелока автомобиля благодаря умной блокировке KeyLess',
                    'path-icon' => "/client/images/products/advantages/relay-protection.avif",
                  ],
                  [
                    'title' => 'УМНЫЙ ДИАЛОГ',
                    'description' => 'Умный диалоговый код управления c индивидуальными ключами шифрования гарантирует надежную защиту от всех известных кодграбберов',
                  ...
                  [
                    'title' => 'ВСТРОЕННЫЙ ЗВУКОВОЙ ИЗВЕЩАТЕЛЬ',
                    'description' => 'При реализации функции авторизации по PIN-коду настраивается звуковое оповещение владельца охранного комплекса о необходимости его введения штатными кнопками автомобиля',
                    'path-icon' => "/client/images/products/advantages/sound.avif",
                  ],
                  [
                    'title' => 'SUPER SLAVE',
                    'description' => 'Управление охраной автомобиля штатным брелком с надежной дополнительной диалоговой авторизацией по основному брелку StarLine',
                    'path-icon' => "/client/images/products/advantages/super-slave-white.avif",
                  ],
                  [
                    'title' => 'НЕВИДИМАЯ БЛОКИРОВКА',
                ...
                'items-service' => [
                  [
                    'title' => 'АВТОЗАПУСК ПО МУЛЬТИСЦЕНАРИЯМ',
                    'description' => 'Интеллектуальный автозапуск позволяет осуществлять дистанционный и автоматический запуск двигателя по температуре, в заданное время, по просадке АКБ или дням недели. Комфорт гарантирован',
                    'path-icon' => "/client/images/products/advantages/autostart.avif",
                  ],
                  [
                  ...
                  [
                    'title' => 'УМНАЯ ЦИФРОВАЯ ИНТЕГРАЦИЯ 3CAN+4LIN',
                    'description' => '3CAN+4LIN интерфейс обеспечивает быструю, удобную и безопасную установку охранного оборудования StarLine на современные автомобили, оснащенные шинами CAN или LIN',
                    'path-icon' => "/client/images/products/advantages/3can4lin.avif",
                  ],
                  [
                    'title' => 'УПРАВЛЕНИЕ С ТЕЛЕФОНА',
                    'description' => 'Интегрированный GSM-интерфейс позволяет управлять охранными и сервисными функциями комплекса, получать оповещения о статусе охраны на ваш мобильный телефон. 2 SIM-карты разных операторов гарантируют надежную связь',
                    'path-icon' => "/client/images/products/advantages/gsm-control.avif",
                  ],
                  [
                    'title' => 'БЕСПЛАТНЫЙ МОНИТОРИНГ',
                    'description' => 'С помощью простого и удобного мониторинга <a href="https://www.starline-online.ru/" target="_blank">STARLINE.ONLINE</a> вы сможете с точностью до нескольких метров узнать местонахождение своего транспортного средства',
                    'path-icon' => "/client/images/products/advantages/gps-glonass.avif",
                  ],
                  [
                    'title' => 'ВСЕГДА НА СВЯЗИ',
                    'description' => 'Интегрированный SIM-чип МТС обеспечивает высокое качество сотовой связи, устойчивость к экстремальным температурам и вибрациям. Автоматическое переключение с SIM-чип на SIM-карту другого оператора гарантирует надежный прием сотовой связи и постоянный контроль транспортного средства, даже в случае потери сигнала одного из сотовых операторов',
                    'path-icon' => "/client/images/products/advantages/2sim.avif",
                  ],
                  [
                    'title' => 'УМНАЯ АВТОДИАГНОСТИКА',
                    'description' => 'Экономьте на диагностике транспортного средства — получайте информацию о состоянии автомобиля на мобильный телефон в приложении StarLine или на мониторинговом сайте <a href="https://www.starline-online.ru/" target="_blank">STARLINE.ONLINE</a> ',
                    'path-icon' => "/client/images/products/advantages/functions-smart-diagnostic.avif",
                  ],
                ],
              ],
              'ХАРАКТЕРИСТИКИ' => [
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                    'description' => 'Комплект включает в себя один GSM-модуль StarLine. Модуль предназначен для установки в сигнализации четвертого поколения: StarLine D94, StarLine D64, StarLine B94, StarLine E90 и т.д., включая StarLine A93 и StarLine A63, установив его на свой автомобиль, владелец получает возможность управлять своим транспортным средством на любом удалении от него посредством отправки команд с мобильного телефона и использования специального мобильного приложения StarLine для Android и iPhone.',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [
                [
                  'description' => '1 Год при условии установки нашим специалистом.',
                ],
              ],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
            ],
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                    'description' => 'Интеграция GSM-интерфейса StarLine позволяет управлять охранными и сервисными функциями, получать оповещения о статусе охраны на мобильный телефон без ограничения расстояния во всей зоне действия сетей GSM.<br><br>Предназначен для использования в моделях StarLine A66 2CAN+2LIN, StarLine A96 2CAN+2LIN, StarLine B66 2CAN+2LIN, StarLine B96 2CAN+2LIN.',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [
                [
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                    'description' => 'Внешняя GPS/ГЛОНАСС антенна позволяет получить точную координату местоположения автомобиля. Может быть подключена к любой модели сигнализации StarLine при условии наличия GSM модуля. ',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [
                [
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                'description' => 'Интерфейсы CAN и LIN обеспечивают наиболее полный функционал на более чем 900 моделей автомобилей,<br><br>
              ...
              Для удобной настройки и обновления программного обеспечения модулей 2CAN, CAN+LIN скачайте приложение "Программатор StarLine CAN Телематика" с сайта <a href="https://can.starline.ru/" target="_blank">CAN.STARLINE.RU</a></a>.<br><br>
              ...
              Список поддерживаемых моделей автоомобилей и функций для каждого автомобиля смотрите на сайте <a href="https://can.starline.ru/" target="_blank">CAN.STARLINE.RU</a></a>..
            ',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [],
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                'description' => 'Данная модель сирены прекрасно подойдет к любой автосигнализации. Имеет 6 тонов звучания и мощность 20 W.',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                'description' => 'Sheriff - аналоговый доводчик  четырех стекол, предназначен для подключения к автомобилям, оборудованными обычными (аналоговыми) стеклоподъемниками. Как правило, данное оборудование устанавливается вместе с автосигналлизацией.',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
          ...
          [
            ...
            'tabs' => [
              'ОПИСАНИЕ' => [
                'description' => 'Моторчик-толкатель центрального замка предназначен для ремонта систем центральных замков, а также для установки в автомобили, не оборудованные системой центрального замка, либо имеющие не полный центрозамок, например в 3 из 4 дверей.',
              ],
              'ХАРАКТЕРИСТИКИ' => [],
              'ГАРАНТИЯ' => [],
              'СОПУТСТВУЮЩИЕ ТОВАРЫ' => [],
